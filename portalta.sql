    ...
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="portalta" targettable="user">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `user`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="portalta" targettable="tugas_akhir">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tugas_akhir`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="portalta" targettable="user">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tugas_akhir`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="portalta" targettable="register">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tugas_akhir`  
ORDER BY `tugas_akhir`.`id` ASC</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="portalta" targettable="tugas_akhir">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tugas_akhir`  
ORDER BY `tugas_akhir`.`file_directory` ASC</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="portalta" targettable="tugas_akhir">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tugas_akhir`  
ORDER BY `tugas_akhir`.`file_url` ASC</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="portalta" targettable="user">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tugas_akhir`  
ORDER BY `tugas_akhir`.`file_url`  DESC</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="portalta" targettable="tugas_akhir">
                            <div class="action_content">
...
ORDER BY `tugas_akhir`.`file_url`  ASC</span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tugas_akhir` WHERE email1 = &#039;masaaadeismail@gmail.com&#039;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="portalta" targettable="tugas_akhir">
                            <div class="action_content">
